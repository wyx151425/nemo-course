...
public class NemoInterceptor implements HandlerInterceptor {
    ...
    private static final String API_INDEX_BOOK = "%s/api/books/index";
    private static final String API_INDEX_AUTHOR = "%s/api/authors/index";
    private static final String API_BOOK_LIST = "%s/api/books";
    private static final String API_AUTHOR_LIST = "%s/api/authors";
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (contextPath.equals(uri)
                ...
                || String.format(API_INDEX_BOOK, contextPath).equals(uri)
                || String.format(API_INDEX_AUTHOR, contextPath).equals(uri)
                || String.format(API_BOOK_LIST, contextPath).equals(uri)
                || String.format(API_AUTHOR_LIST, contextPath).equals(uri)) {
            return true;
        }
